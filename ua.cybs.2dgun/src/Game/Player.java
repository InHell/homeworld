...
public class Player extends Entity {
	...
	// numeraciya dlya napravleniya unita
	...
	// metod dlya virezki nujnogo jpg
	...
	public Player(EntityType type, float x, float y, float scale, float speed, TextureAtlas atlas) {
		super(type, x, y);
